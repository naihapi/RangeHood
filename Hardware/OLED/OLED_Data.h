...
extern const uint8_t OLEDData_Icon_LightState[];
extern const uint8_t OLEDData_Icon_Red[];
extern const uint8_t OLEDData_Icon_Green[];
extern const uint8_t OLEDData_Icon_Blue[];
extern const uint8_t OLEDData_Icon_LightAuto[];
